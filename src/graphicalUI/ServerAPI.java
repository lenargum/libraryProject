...
public class ServerAPI {
    ...
    public ServerAPI() {
        ...
        librarian.addDocumentInLibrary(new Book("Object-oriented Programming", "Bertrand Meyer", librarian.getListOfDocuments().size(), true, true, 500));
        librarian.addDocumentInLibrary(new Book("Introduction to Algorithms", "Thomas Cormen", librarian.getListOfDocuments().size(), true, true, 700));
        librarian.addDocumentInLibrary(new Book("50 shades of Gray", "E. L. James", librarian.getListOfDocuments().size(), false, true, 100));
        librarian.addDocumentInLibrary(new AudioVideoMaterial("Audio 1", "Author", librarian.getListOfDocuments().size(), 39.99f, true, true));
        librarian.addDocumentInLibrary(new Book("Secret materials", "Mr. Security", librarian.getListOfDocuments().size(), true, false, 1e+6f));
    }
