			...
			while (true) {
				...
				switch (input) {
					case 0:
						...
						break;
					case 1:
						System.out.println("Use README or\nyou can contact @gafmn, @stalem, @lenargum at anytime!");
						break;
					case 2:
						bookManagerMenu(in, user, db);
						break;
					case 3:
						libraryMenu(in, user, db);
						break;
				}
	...
	private static void bookManagerMenu(Scanner in, Patron user, Database db) throws SQLException {
		...
		switch (input) {
			case 0:
				break;
			case 1:
				user.returnDocument(enterNum(in, 0, "Enter document id: "), db);
				break;
		}
	}
	...
	private static void books(Scanner in, Patron user, Database db) throws SQLException {
		...
		switch (input) {
			case 0:
				break;
			case 1:
				user.takeBook(enterNum(in, 0, "Enter book id: "), db);
				break;
		}
	}
	...
	private static void avs(Scanner in, Patron user, Database db) throws SQLException {
		...
		switch (input) {
			case 0:
				break;
			case 1:
				user.takeAV(enterNum(in, 0, "Enter audio/video id: "), db);
				break;
		}
	}
	...
	private static void articles(Scanner in, Patron user, Database db) throws SQLException, ParseException {
		...
		switch (input) {
			case 0:
				break;
			case 1:
				user.takeArticle(enterNum(in, 0, "Enter article id: "), db);
				break;
		}
	}
